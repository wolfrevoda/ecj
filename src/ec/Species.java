...
public abstract class Species implements Prototype
    ...
    */
    ...
    public Individual newIndividual(final EvolutionState state, int thread, Individual[] subIndividual, int count)
    {
    	 Individual newind = (Individual)(i_prototype.clone());
    ...
    */
    ...
    public void setup(final EvolutionState state, final Parameter base)
        ...
        // load our individual prototype, here define the species of individual prototype is GPIndividual
