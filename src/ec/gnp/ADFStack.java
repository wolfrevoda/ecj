...
public class ADFStack implements Prototype 
{
    ...
    {
    	return GNPDefaults.base().push(P_ADFSTACK);
    }
    ...
    public Object clone()
    {
    	try
    	{
    		...
    		for(int i = 0; i < onStack; ++i)
    			myobj.stack[i] = (ADFContext)(stack[i].clone());
    		for(int i = 0; i < onSubstack; ++i)
    			myobj.substack[i] = (ADFContext)(substack[i].clone());
    		for(int i = 0; i < inReserve; ++i)
    			myobj.reserve[i] = (ADFContext)(reserve[i].clone());
    		return myobj;
    	}
    ...
    public final ADFContext get()
    {
    	...
    	if(inReserve > 0)
    		...
    		obj = (ADFContext)(context_proto.clone());
    	return obj;
    }
